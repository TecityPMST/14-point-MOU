...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **1 Sep 2026 (09:45 SGT)** refresh (Day 76 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no further exchange of fire has been reported since the IRGC's 31 Aug missile attack on two US bases in Jordan, but Trump said he was weighing new strikes, called the conflict "a relatively little war" and disputed his commanders' warnings against extending operations, while Vance confirmed the Kharg Island video was deliberate signalling; Iranian state media put the Larak toll at two killed, the first attributable figure; the maritime record turned openly contested, with Tehran reporting a supertanker ablaze after striking two mines, CENTCOM stating no ship has hit a mine in the strait and UKMTO logging no such incident, while Iran seized a bulk carrier and transits stayed below half the pre-war norm; 82nd Airborne families were told Middle East deployments now run into 2027; Bessent set the US terms as surrender of the nuclear programme, handover of the HEU, an end to proxy support and an open strait; Qatar condemned Iran's attacks on Jordan and the UAE as a violation of their sovereignty; Brent settled around $90.78, the Tehran open-market dollar hit a 365-day high near 2,111,000 rials, and OFAC's newest Iran item is still the 28 Aug designation package): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
