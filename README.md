...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **8 Sep 2026 (09:29 SGT)** refresh (Day 83 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; the escalation of 5–6 Sep hardened into structure, with Supreme National Security Council secretary Mohsen Rezaei giving the promised exclusion zone its first boundaries on 7 Sep — beginning at the US Navy’s blockade line and reaching into the Persian Gulf, with any ship entering added to Iran’s own sanctions list — and saying maps of a new corridor lying in Iranian and Omani waters, with Iran holding management rights, had been agreed and should be signed within days; he attached a condition the memorandum does not contain, that Iran will commit to the strait being open only once the United States stops attacking it, making Article 5 hostage to Article 1; Iran’s foreign ministry said the Oman track had reached its final stage and would be registered with the International Maritime Organization within days — the only functioning channel in the file, and one running outside the memorandum, without the United States and without the mediators Rezaei disowned two days earlier; traffic data worsened, Kpler putting the 10-day average at 10 commodity ships a day, the lowest since May against more than 130 before the war, while UKMTO counted 59 transits in 48 hours; Brent touched $96.95 and US pump prices set a Labor Day record at $4.14 a gallon; CENTCOM posted nothing after the 5 Sep tanker strike while Iran’s parliament speaker declared the era of proportionate responses over and Tehran’s foreign ministry called the US strikes a war crime under Article 2(4) of the Charter, with Israeli strikes on Lebanon announced for a second consecutive day; the blockade is being institutionalised, the Justice Department reviving maritime prize law — unused since 1898 — so seized vessels and cargo can be condemned and sold with proceeds paid to the Treasury; OFAC posted nothing Iran-related for four days and five suspended general licences, personal remittances among them, wind down on 8 Sep; and the IAEA Board opened in Vienna on 7 Sep with a US and E3 draft referring Iran to the Security Council, Grossi calling the lack of contact regrettable and saying the shortest route to a good outcome was for Iran to engage): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
