...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **22 Sep 2026 (10:15 SGT)** refresh (Day 97 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. Iran's written three-item precondition package is still unanswered: US envoy Waltz said Trump is 'always open to a deal' but that Iran's negotiators must carry the Supreme Leader's authority, while Qatar says it has spent two weeks trading ideas with both sides; Trump addresses the General Assembly on 22 September and Pezeshkian on 23 September. UKMTO logged an unknown projectile striking an inbound tanker in Hormuz on 21 September, injuring two crew, and transit counts stayed low and contested. Sanctions tightened: Bessent says Iranian airlines will be shut down worldwide from 23 September, when the last wind-down licences lapse, and a newly signed statute extends the Iran Sanctions Act to 2031. OFAC, the IAEA and the Security Council posted nothing new on Iran, and the 1737 Panel of Experts lapses on 27 September): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
