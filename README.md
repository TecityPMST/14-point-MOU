...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **28 Aug 2026** refresh (Day 72 of 60, and six months to the day since major combat operations began — the window expired on 16 Aug without a final deal or an agreed extension; a senior Iranian source told Reuters the Iran–Oman understanding on the strait's waters and revenues is not finalised, UKMTO logged a second tanker struck in the strait inside a week, the published blockade tally rose to 75 vessels redirected, Qatar's prime minister made the first high-level Tehran visit since the war began while the White House said no negotiations are taking place, and OFAC published no Iran-related action for a third day): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
