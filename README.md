...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **14 Aug 2026** refresh (Day 58 of 60): Breached 7 · At Risk / Contested 6 · Conditional 1. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
