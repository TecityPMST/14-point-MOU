...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **21 Sep 2026 (09:45 SGT)** refresh (Day 96 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. The one real movement is diplomatic: on 19–20 September Iran transmitted a written three-item precondition package to Washington through Qatar and Pakistan — end the war on all fronts, release frozen funds, lift the naval blockade — and Trump confirmed he had received it and not yet replied, while saying he would 'probably be open' to meeting President Pezeshkian; both are in New York for the General Assembly. CENTCOM raised vessels redirected by the blockade to 109 and its commander said the blockade holds Iranian exports at zero, while the Pentagon put the war's cost to Congress at about $43.6bn. Reuters counted four Hormuz transits on 17 September against a 10-day average of 16, and Iran extended its claimed control over the strait to subsea data cables. OFAC posted nothing Iran-related after 17 September, but wind-down licence GL CC lapsed on 19 September with nothing in its place. The Saudi-led coalition says it intercepted the first Houthi ballistic missile aimed at Riyadh in this escalation, and Iran's NPT-exit effort advanced to a formally tabled bill): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
