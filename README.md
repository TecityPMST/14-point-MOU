...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **14 Sep 2026 (10:20 SGT)** refresh (Day 89 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh, and the weekend's movement was almost entirely negative. The most consequential development was a diplomatic one that did not happen: Oman postponed the Salalah ministerial set for 14 September — Iran, Iraq and five Gulf states, convened to be briefed on a new Strait of Hormuz maritime route agreed between Tehran and Muscat and destined for filing with the International Maritime Organization — announcing the deferral on 13 September with no replacement date, the Oman News Agency saying it was to create conditions conducive to a constructive dialogue and Iran saying some regional states had asked for it, after Bahrain had already refused to attend on the ground that the strait must stay open without discrimination, fees or permits. What the aborted meeting exposed matters as much as its collapse: the passage regime under discussion was one of permits and possible service fees, the opposite of the toll-free passage Article 5 required, and Foreign Minister Araghchi was explicit that the arrangement by no means means the strait is reopening and that reopening depends on the United States returning to its Islamabad commitments — a party admission that Articles 4, 5, 10 and 11 remain unperformed. The military record moved the other way: a container ship was struck by an unidentified projectile near Hengam Island off Qeshm at about 5am on 13 September, killing one crew member and wounding three or four, the second merchant-crew death in four days; drones launched from Maysan province in Iraq hit Saudi Arabia's East–West crude pipeline on 11 September, forcing shut the principal route for bypassing the strait and driving Brent to about $108; and Houthi forces took Mokha port and then Mayyun island in the Bab al-Mandeb. CENTCOM has published nothing since 8 September, while press relays put its cumulative blockade count at 100 vessels redirected with zero unauthorised passages — recorded UNVERIFIED and inconsistent with the 91 on its own index. OFAC's Recent Actions and Treasury's release index both return verified negatives for 11 to 14 September, so the 10 September presumption-of-denial posture stands unamended, with a further large-bank designation announced for 14 September but not yet executed. On the nuclear file nothing moved toward verification five days after the Board's non-compliance finding; the only multilateral product was the BRICS New Delhi Declaration of 12 September, which deplored attacks on safeguarded nuclear facilities while naming no party, and the 1737 Panel of Experts mandate expires on 27 September): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
