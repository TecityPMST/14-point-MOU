...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **17 Sep 2026 (09:34 SGT)** refresh (Day 92 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. China's Wang Yi urged Washington and Tehran to return to the Islamabad MoU; Araghchi said Iran regards the memorandum as still in force but the US must honour its commitments first, and no US reply or mediated round followed. The Saudi-led coalition said it destroyed a drone headed for Mecca, which the Houthis deny targeting, and Fox News reported an unconfirmed Iranian attack on a US-contracted ship near Hormuz. CENTCOM put vessels redirected by the blockade at 103, Kpler counted four Hormuz transits on 15 September, and the CBO put war costs at about $38bn to 1 August. OFAC took no Iran action, Secretary Bessent promised vigorous enforcement from 23 September, and the Security Council votes on renewing the 1737 Panel of Experts on 17 September in New York, with a Chinese or Russian veto expected): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
