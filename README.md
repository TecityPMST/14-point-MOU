...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **2 Sep 2026 (09:42 SGT)** refresh (Day 77 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; CENTCOM ran a second strike wave on 1 Sep against IRGC air-defence, radar, maritime, mine-laying and communications targets and Iran answered with ballistic missiles at Jordan, where 13 were detected and 10 intercepted, and drones over Kuwait and Bahrain — four exchanges of fire across three third countries in 72 hours with no deconfliction contact recorded; Trump said Iran would be hit "much harder" and that an agreement with Iran is not worth the paper it is written on, while Bessent said the MOU did not work because Iran was not ready for a deal and Pezeshkian, at the SCO summit in Bishkek, offered immediate reciprocity if Washington returned to its commitments; UKMTO Warning 124-26 logged a tanker struck by three unknown projectiles east of Khasab and Marisks identified a second vessel hit eight minutes earlier on the same southern corridor the US calls open; Iran's parliament speaker urged citizens to ration gasoline because the blockade prevents sufficient fuel imports; OFAC's newest Iran item is still the 28 Aug package, but Treasury moved to sever Banque Misr's Emirati branches from the US financial system and US testing services in Iran stopped under the suspended General License G; the Tehran open-market dollar weakened again to about 2,151,000 rials; and France, holding the Council presidency, confirmed a 17 Sep vote on renewing the Iran panel of experts, resolving a flag carried UNVERIFIED for two refreshes): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
