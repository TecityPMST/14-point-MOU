...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **9 Sep 2026 (09:20 SGT)** refresh (Day 84 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; the file is now escalating on every track at once: CENTCOM announced on 8 September that US forces destroyed five IRGC crude carriers, four in the Gulf of Oman and one near Kharg Island, after the Guard targeted a US Navy warship with ballistic missiles twice in two days — eight tankers destroyed in four days, with the command stating that Iran has no means to defend them; Iran widened the target set, the IRGC telling tanker crews in Kuwaiti and Bahraini ports on 9 September to abandon their vessels as legitimate targets, while Iran-aligned Houthi forces struck Abha airport, King Khalid air base and Aramco facilities at Abha and Jizan, wounding 73, and Saudi Arabia struck back in Yemen the same day; at sea the breach changed shape rather than merely deepening, with Iran declaring a restricted zone beginning at the US Navy's blockade line and reaching into the Persian Gulf — any ship entering added to Iran's own sanctions list — and moving to file an Iran–Oman corridor with the International Maritime Organization whose entry and part of its exit run through Iranian territorial waters, a passage regime managed by Iran, registered with a UN agency, outside the memorandum and without the United States; Kpler's 10-day average fell to about 10 commodity vessels a day and Qatar warned of an industrial catastrophe if the crisis persists; OFAC's 8 September action added 41 entities to the SDN list — most of Iran's remaining active airlines plus support firms in the UAE, Britain, Malaysia, Turkey and Kazakhstan — suspended General License J-1, issued wind-down-only authorities and let the five August suspensions including personal remittances take effect, while the Justice Department's revival of maritime prize law would let courts condemn and sell seized vessels outright; and in Vienna the Board of Governors heard Grossi call the situation a serious proliferation concern requiring utmost urgency and confirm the agency cannot verify Iran's nuclear material, with a US and E3 draft referring Iran to the Security Council awaiting a vote within the week): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
