...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **11 Sep 2026 (09:40 SGT)** refresh (Day 86 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh, the movement being in how firmly the existing breaches are fixed in place: on 10 September Treasury designated seventeen individuals and entities across Iraq, Lebanon, the UAE and Türkiye under Operation Economic Outcast and moved OFAC's Iran Statement of Licensing Policy to a presumption of denial, refusing most outstanding Iran licence applications with carve-outs only where law requires or where life, limb or environmental safety is at risk, which closes the administrative route on which Articles 6, 10 and 11 depend and hardens two of the five gates Article 13 sets, with Reuters reporting the posture holds until Iran changes course on Hormuz, on attacks against US personnel and Gulf partners and on its weapons programmes, alongside a $1,427,230 settlement covering 39 apparent violations; on the military track the tanker war produced the first merchant-crew death in this record, Iran striking ten ships near Hormuz after the US destroyed five Iranian tankers and a seafarer being killed aboard the products tanker Hercules Star at anchor off Dubai with another missing, while Hormuz transits fell to seven vessels on 9 September against a ten-day average of fourteen, Rystad put flows at about 2 million bpd against 19–20 million pre-crisis and Brent was quoted near $107; the war widened at a second chokepoint as Houthi forces seized Mocha on the Red Sea coast within reach of the Bab al-Mandeb and Saudi Arabia answered with around forty air strikes, and Israeli forces demolished the Ali Taher tunnel complex in southern Lebanon with more than 1,100 tonnes of explosives; at the Security Council's 10218th meeting the permanent members clashed over whether the snapback machinery legally exists, the agenda surviving a Russian and Chinese procedural challenge 11 votes to 2, with the 1737 Panel of Experts mandate expiring on 27 September, while Iran formally rejected the IAEA referral and the UK told the Council Iran holds more than 400 kg of uranium enriched to 60 percent, which France put at roughly ten devices' worth of material): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
