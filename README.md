...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **31 Aug 2026** refresh (Day 75 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; the roughly thirty-night lull inside Iran ended when US forces struck IRGC rocket launchers on Larak Island on 30 Aug over an alleged sea-mine threat to Hormuz, and the IRGC answered with missiles against two US bases in Jordan on 31 Aug, with Jordan saying it intercepted eight; UKMTO logged a third tanker struck in eight days, CENTCOM's blockade tally rose to 83 vessels redirected, Brent went back above $90, and OFAC published no Iran-related action on 29–31 Aug after its 28 Aug designation package): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
