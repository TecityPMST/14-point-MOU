...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **4 Sep 2026 (09:58 SGT)** refresh (Day 79 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; Iran struck US Gulf allies for a second consecutive night with drones at Kuwait and Bahrain, Iranian state television confirming Tehran was deliberately targeting US bases on Kuwaiti soil, drawing condemnation from Kuwait’s foreign ministry, Arab interior ministers and Saudi Arabia, while a US defence official denied any base was hit; Iran’s health ministry put the toll from the 1 Sep American wave at 18 killed and at least 108 wounded, 105 of them women and children, and Tehran took the Kuhestak wedding strike to the UN as a war crime as the IRGC chief vowed it would be avenged; in Lebanon Israel took the Ali al-Taher ridge and raided Halta, hours after a Reuters account — disputed by the White House — that Iran had warned Washington off the operation through Oman; Vice President Vance said the US is not talking to Iran and will not unless Tehran stops firing on commercial shipping, and would not say when the conflict ends; a live-blog URL circulating with a Geneva peace-signing slug was checked and found to be a recycled June 2026 headline, not a new deal; CENTCOM’s redirected-vessel tally rose to 87 with three ships disabled and two boarded; six vessels transited Hormuz on 2 Sep against a pre-crisis baseline near 85 a day, Iran updated its violating-vessel blacklist and Mitsui O.S.K. dropped its October restart guidance, with war-risk cover adding an estimated $7–8 a barrel and Brent above $96; Bessent said the EU had officially joined Operation Economic Outcast, though the European text he circulated only welcomes additional pressure; OFAC published nothing on Iran on 3 or 4 Sep, leaving 28 Aug as the newest entry, and the rial sat near 2.22 million to the dollar; and the IAEA said nothing new, leaving the nuclear file where the 1 Sep quarterly report left it, bound for the Board of 21–25 Sep): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
