...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **16 Sep 2026 (09:59 SGT)** refresh (Day 91 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. The lull did not hold: US forces destroyed two Iranian boats off Hormozgan on 14 September — CENTCOM says they tried to seize a US sea drone, Iran says they were fishing boats — and Israeli strikes killed at least 13 in southern Lebanon as Hezbollah resumed drone fire. President Trump said the US is open to engaging with Iran; Tehran's security council secretary replied that there will be no talks until reparations, sanctions relief and frozen assets are delivered. Iran's Strait Authority blacklisted 77 ships and the IRGC declared Hormuz blocked, with four commodity-vessel transits counted on 14 September. OFAC posted nothing after the 14 September VTB designation, and a Security Council vote on renewing the 1737 Panel of Experts is due on 17 September): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
