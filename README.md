...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **3 Sep 2026 (09:44 SGT)** refresh (Day 78 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; a second US strike wave in three days hit dozens of targets along Iran's southern coast and Iranian state media said a missile struck a house hosting a wedding in Kuhestak, killing four and wounding at least 68, with a provincial official first reporting five and CENTCOM saying only that it was looking into the reports; at least 18 were killed across Iran, seven of them in Khuzestan, and Iran put its own losses at four Revolutionary Guards and ten Basij; Iran answered with missiles and drones against US facilities in Jordan, Bahrain, Kuwait and Iraqi Erbil — Jordan intercepted 10 of 13 ballistic missiles and Kurdish authorities downed ten drones — while Hezbollah sent two explosive drones at Israeli troops in southern Lebanon; Rubio said of returning to the memorandum that "that ship, in many ways, has sailed" and Trump said he could not care less whether Iran signs, telling reporters the bombing would not last "too long"; Bahri named the struck tanker SIDR and said two Filipino seafarers were killed on 31 Aug, the first merchant deaths in the strait since the MOU, while the IRGC said two tankers hit mines and burned and CENTCOM replied that no ships have hit mines; Brent reached about $95 and the rial hit a record 2.20 million to the dollar; OFAC's newest Iran item is still the 28 Aug package and its 2 Sep action was Venezuela business; and the IAEA's new quarterly report says access to the bombed sites is still refused, with unaccounted-for material referred to the Board of 21–25 Sep, as Security Council Report puts the Panel of Experts mandate expiry at 27 Sep with renewal likely blocked by China and Russia): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
