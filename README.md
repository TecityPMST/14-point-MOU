...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **18 Sep 2026 (09:14 SGT)** refresh (Day 93 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. Russia and China vetoed the US draft renewing the UN's 1737 Panel of Experts on 17 September (11 in favour, Pakistan and Somalia abstaining), so the panel's mandate lapses on 27 September. OFAC designated the BitBank crypto exchange, which Treasury says moved funds to the IRGC and handled Hormuz transit payments, and issued no licence relief. Iranian state media say the IRGC struck the tanker Trend in Hormuz on the night of 17 September; CENTCOM puts vessels redirected by the blockade at 104, and Kpler counted three Hormuz transits on 16 September. Debris from a Houthi drone killed a resident of Taif, the first fatality inside Saudi Arabia in this escalation, and there is still no US reply to China's call to return to the MoU): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
