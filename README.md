...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **15 Sep 2026 (09:50 SGT)** refresh (Day 90 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. The announced large-bank designation was executed: on 14 September OFAC designated Russia's VTB Bank under the Iran financial-sector order, citing among other things its movement of billions in frozen Iranian assets, with a secondary-sanctions warning to foreign banks and no Iran licence issued — a new sanction against Articles 7, 9, 10 and 11. The tanker El Gaia was hit on 13 September with one Indian seafarer missing, its cause disputed between an IRGC mine claim and a CENTCOM account of an Iranian drone. Iran said Saudi Arabia sought the Salalah postponement and that its routed, tolled Hormuz corridor understanding with Oman is finalised regardless. The IAEA says it has had no inspection activity in Iran for more than six months): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
