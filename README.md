...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **23 Sep 2026 (10:18 SGT)** refresh (Day 98 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; no status changed this refresh. The deadlock broke procedurally: on 22 September US and Iranian officials met for about three hours on the UN General Assembly sidelines with Qatar's prime minister mediating, the first acknowledged direct contact since signature. Trump called it very good and productive; the US participants are contested between Witkoff and Kushner and Secretary Rubio, and whether a second session is scheduled is disputed. The agenda was Iran's preconditions — lift the blockade, pay the frozen assets, end the fighting — not a final-deal text, and Reuters separately reported an unaccepted Iranian offer to reopen the Strait of Hormuz within seven days if Washington eases military pressure. Trump told the Assembly the choice is a deal or annihilating the Islamic Republic, and said he expects Iran to wait for the November midterms. Nothing moved on the ground: CENTCOM's blockade count resolved at 110 vessels as of 21 September, no tracker published a transit count for 21–22 September, OFAC and the IAEA posted nothing new, the aviation wind-down licences lapse on 23 September grounding Iranian carriers worldwide, and the 1737 Panel of Experts lapses on 27 September with the Committee still chairless): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
