...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **27 Aug 2026** refresh (Day 71 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; Iran and Oman agreed a temporary 7-mile joint corridor through the Strait of Hormuz with a joint mine-clearing project, while Tehran said the strait is still not open and the IRGC described an agreed split of the strait's revenues; Qatar's prime minister travelled to Tehran, Rubio told allies there would be no new US strikes "for the time being", and OFAC published no Iran-related action for a third day): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
