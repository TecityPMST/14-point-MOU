...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **11 Sep 2026 (10:15 SGT)** refresh (Day 86 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; this is the second check of 11 September, run against the 09:40 baseline, and no status changed. What it added was the codifying primary document behind the week's decisive administrative act: OFAC's final rule, published 10 September and effective 8 September, indefinitely stays three regulatory authorisations — 31 CFR 560.522 on payments for overflights of Iranian airspace, 560.528 on specific licences for aircraft safety transactions and 560.529 on bunkering and emergency repairs — together with General License J-1 on temporary reexportation of civil aircraft, giving as its grounds Iran's continued disruption of global energy markets, attacks on partners and allies in the Middle East and reconstitution of its conventional and nuclear weapons programmes. Read with the 10 September move of OFAC's Iran Statement of Licensing Policy to a presumption of denial, the licensing channel on which Article 10's oil waiver, Article 11's frozen-funds release and Article 6's sanctions-relief-enabled financing all depend is closed as stated policy rather than merely unused, and with it two of the five gates Article 13 sets for stage-2 talks; a direct read of OFAC's Recent Actions index at 10:05 SGT confirms no entry dated 11 September, so that posture stands unamended. On the monitoring side Security Council Report records that the substitute UN machinery cannot function either — the 1737 Committee still has no chair and cannot convene, China and Russia rejected eight Panel of Experts candidates in April 2026, and the Panel's mandate expires on 27 September. Everything else on the record is unchanged from the morning: the first merchant-crew death of the tanker war aboard the products tanker Hercules Star off Dubai, Hormuz transits at seven vessels against a ten-day average of fourteen with Rystad putting flows near 2 million bpd against 19–20 million pre-crisis, Brent near $107, Houthi forces holding Mocha within reach of the Bab al-Mandeb, the demolition of the Ali Taher tunnel complex in southern Lebanon, and Iran's outright rejection of the IAEA referral with the UK putting its 60 percent stock above 400 kg): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
