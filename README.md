...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **10 Sep 2026 (09:20 SGT)** refresh (Day 85 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; this refresh carries the first status change in nineteen refreshes: on 9 September the IAEA Board of Governors voted to refer Iran to the UN Security Council for continued non-compliance, reportedly 23 in favour, 3 against with 8 abstentions and Russia, China and Niger opposing — the first such referral in about two decades — calling on Tehran to resume inspections and provide updated declarations of nuclear material while Grossi confirmed the agency cannot verify what became of the uranium enriched to 60 percent, which moves Article 8 from At Risk to Breached on its second limb, on-site down-blending under IAEA supervision, the weaponisation limb remaining unverified rather than shown broken; the military track escalated in step, with Iran answering the destruction of five IRGC crude carriers by firing ballistic missiles at the Muwaffaq Salti air base in Jordan overnight into 9 September — the Jordanian army said it engaged 20 and intercepted 18, with no casualties — and claiming attacks on ten ships near the strait and the capture of an unmanned US submarine, both unverified Iranian claims, while the Pentagon put US wounded in overseas operations at 403 between 7 July and 8 September and Brent crude passed $100 a barrel for the first time in months; on the diplomatic track President Trump said the war would end immediately after the US midterm elections, suggested Iran was stalling to influence the result and, asked about restarting negotiations, said Washington is not looking for it — the first explicit US refusal in this record; the UN Special Envoy for Yemen warned that the Houthi strikes on Saudi energy sites, which wounded 73, threaten to widen the war further; and the economic track was static, with OFAC posting no Iran-related action on 9 or 10 September, leaving the 8 September package of 41 designations, the suspended General License J-1 and the lapsed remittances licence as the operative position, with still no replacement for General License X, no frozen-funds procedure and no reconstruction mechanism): Breached 11 · At Risk / Contested 3 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
