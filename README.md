...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **7 Sep 2026 (09:47 SGT)** refresh (Day 82 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; the war escalated by a category rather than a degree, with the IRGC firing ballistic missiles at a US aircraft carrier and a guided-missile destroyer on 5 Sep — both evaded, no casualties — and CENTCOM answering by permanently disabling the crude carriers M/T Downy off Kharg Island and M/T Stark 1 near Jask and destroying the unladen M/T Kylo in the Gulf of Oman; Iran then said it had struck three tankers on an “unauthorised route” and three US-linked vessels, and claimed a hit on an unmanned US vessel that the US military called a total lie; on 6 Sep Iran’s new security chief Mohsen Rezaei said Tehran will declare an exclusion zone running from the US blockade line through the Strait of Hormuz into the Persian Gulf, adding identified vessels to Iran’s own sanctions list, and turned on the mediators — saying Iran had trusted Pakistan, Qatar and Oman to restrain a violating party, that they did not, and that Tehran now wants “diplomacy with guarantees”, the first explicit statement by a party that the memorandum’s monitoring arrangement failed; the blockade grew rather than lifting, with more than 20 warships behind it, 92 commercial ships redirected and three disabled, up from 87 and three on 4 Sep; throughput stayed the sharpest factual contest, Energy Secretary Chris Wright putting flows at 9 million barrels a day and two-thirds or more of pre-conflict levels against Treasury’s 17 million a week earlier and Kpler’s 10-day average of 13 vessels a day, while conceding the flow depends on US Navy escort; OFAC designated Golden Global Yatirim Bankasi and two affiliates in Türkiye on 4 Sep and posted nothing on Iran since, five suspended general licences wind down on 8 Sep, and the rial sat near 2.25 million to the dollar with inflation around 84 per cent; in Lebanon Israeli strikes killed four and destroyed a hospital at Nabatieh al-Fawqa; the US and the E3 drafted an IAEA Board resolution referring Iran to the Security Council, with the Agency warning that continued denial of access is a proliferation risk to be addressed with the utmost urgency; and Brent traded toward $97): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
