...
> **Snapshot, not a feed.** The dashboard does not update itself. Every figure in it is true as of the "Last refreshed" date in its header and no later. As of the **31 Aug 2026 (16:30 SGT)** refresh (Day 75 of 60 — the window expired on 16 Aug without a final deal or an agreed extension; the roughly thirty-night lull inside Iran ended when US forces struck IRGC rocket launchers on Larak Island on 30 Aug over an alleged sea-mine threat to Hormuz, and the IRGC answered with missiles against two US bases in Jordan on 31 Aug, with Jordan saying it intercepted eight, while Iran's separate claim of a drone attack on Al Minhad in the UAE was denied by Abu Dhabi and is recorded as contested; CENTCOM publicly rejected the IRGC's aggression framing, calling Larak "limited, precise action against IRGC minelaying forces", and its blockade tally stands at 83 vessels redirected; Trump called Iran's earlier strikes on five Gulf states "a very good thing" and posted an AI video of a US pilot attacking Kharg Island; Brent traded around $90.69, and OFAC published no Iran-related action on 29–31 Aug after its 28 Aug designation package): Breached 10 · At Risk / Contested 4 · Conditional 0. Open the dashboard for the current state rather than trusting this line, which is updated by hand.
